...
// Description : This Terratest is used to test the Terraform alb multi targetgroup module .
...
func Test(t *testing.T) {
	...
	Name := terraform.Output(t, terraformOptions, "tags")

	// Check that we get back the outputs that we expect
	assert.Equal(t, "test-alb", Name)
}
